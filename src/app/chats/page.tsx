  ...
  return (
    <div className="flex">
      ...
      <div className="w-1/4 min-h-screen mx-4">
        ...
        {showPopup9 && (
          <div className="flex justify-between items-end group px-0.5 py-6 rounded-lg hover:bg-gray-300">
            ...
            <div className="flex relative">
              ...
              />
              <MoreHorizIcon
                className="absolute top-0 bg-white rounded-full opacity-0 group-hover:opacity-100 "
              ...
              {showPopup2 && (
                <div className="flex flex-col justify-center items-center my-2">
                  ...
                  <div className="max-w-20 w-full relative">
                    <CancelIcon
                      className="absolute -top-10 left-11 rounded-full"
                      sx={{
                        color: "white",
      ...
      {showPopup5 && (
        <div className="fixed inset-0 flex items-center justify-center">
          <div>
            ...
            />
            <CancelIcon
              className="absolute top-16 right-72 rounded-full"
              sx={{
                color: "white",
                backgroundColor: "black",
                width: 40,
          ...
          <div className="">
            <div className="bg-white rounded-lg p-6 w-fit h-48 border shadow-2xl relative">
              ...
              <div className="flex gap-2">
                <button
                  onClick={togglePopup6}
                  className="w-64 bg-gray-400 rounded-lg mt-2 p-3 border-none"
                >
                  Cancel
                </button>
                <button
                  onClick={togglePopup6}
                  className="w-64 bg-red-600 text-white rounded-lg mt-2 p-3 border-none"
                >
                  Save
                </button>
              </div>
